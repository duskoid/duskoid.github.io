...
Maka, konsep yang saya tawarkan—sebagai logika mesin abstraknya—adalah **menggeser tumpuan solusi dari "Atom" (fisik) ke "Bits" (perangkat lunak).** Konsep ini bekerja dengan cara mengarahkan kekuatan komputasi *smartphone* (*ubiquitous computing*) untuk mengangkat beban diagnosis untuk disabilitas mental atau kognitif yang selama ini hanya bisa dilakukan oleh klinik mahal.